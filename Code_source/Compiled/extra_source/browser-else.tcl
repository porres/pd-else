    ...
    set menutree { 
        {else
            ...
            {control:\ fade\ pan\ routing
                {fader~ autofade~ autofade2~ balance~ pan~ pan2~ pan4~ pan8~ spread~ spread.mc~ rotate~ rotate.mc~ xfade~ xfade.mc~ xgate~ xgate.mc~ xgate2~ xgate2.mc~ xselect~ xselect2~ xselect2.mc~ xselect.mc~ mtx~}}
            {control:\ sequencers
