...
comb.filt~.class.sources := classes/comb.filt~.c
...
fold~.class.sources := classes/fold~.c
freq.shift~.class.sources := classes/freq.shift~.c
function~.class.sources := classes/function~.c
...
sig2float~.class.sources := classes/sig2float~.c
s2f~.class.sources := classes/s2f~.c
