...
"    set ::dialog_elsegui::var_n_mode_sym($vid) [string map {{\\ } \" \"} $n_mode]\n"
...
"    entry $id.num.xpos.ent -textvariable ::dialog_elsegui::var_xpos($vid) -width 4\n"
"    pack $id.num.xpos.ent $id.num.xpos.lab -side right -anchor e\n"
        // Number ypos:
"    frame $id.num.ypos\n"
"    label $id.num.ypos.lab -text [_ \"Ypos: \"]\n"
"    entry $id.num.ypos.ent -textvariable ::dialog_elsegui::var_ypos($vid) -width 4\n"
...
"                $::dialog_elsegui::var_n_mode_sym($vid) \\\n"
