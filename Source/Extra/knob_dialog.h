...
"\n"
//"array set ::dialog_knob::var_n_mode {} ;\n"
"array set ::dialog_knob::var_n_mode_sym {} ;\n"
...
"    set ::dialog_knob::var_arc_shown($vid) $show_arc \n"
...
"    set ::dialog_knob::var_n_mode_sym($vid) [string map {{\\ } \" \"} $n_mode]\n"
...
// make checkboxes apply in macOS (a variable, not a procedure)
"    set applymacos \"\"\n"
"    if {$::windowingsystem eq \"aqua\"} {\n"
"        set applymacos \"::dialog_knob::apply $id\"\n"
"    }\n"
"\n"
...
"    entry $id.knobstyle.dim.w_ent -textvariable ::dialog_knob::var_size($vid) -width 4\n"
...
"    checkbutton $id.knobstyle.square.ent -variable ::dialog_knob::var_square($vid) -width 5\\\n"
"        -command $applymacos\n"
...
"    checkbutton $id.arcsettings.arc.ent -variable ::dialog_knob::var_arc_shown($vid) -width 5\\\n"
"        -command $applymacos\n"
...
"                $::dialog_knob::var_n_mode_sym($vid) \\\n"
...
"        bind $id.knobstyle.dim.w_ent <KeyPress-Return> \"::dialog_knob::bind_enter_to_apply $id\"\n"
...
"        $id.knobstyle.dim.w_ent config -validate focusin -vcmd \"::dialog_knob::unbind_return $id\"\n"
