...
"    set paramname empty\n"
"\n"
//  Set send, param and receive if not empty
...
"        set applycmd \"::dialog_knob::apply $mytoplevel\"\n"
"    }\n"
// Send/param/receive entry
"    labelframe $mytoplevel.s_r -borderwidth 1 -padx 5 -pady 5 -text [_ \"Send/Param/Receive\"]\n"
